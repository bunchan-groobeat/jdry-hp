...
(function () {
  ...
  function initTypewriter() {
    ...
    /* 1文字あたりの間隔。水野谷は165ms。この見出しは52文字と長いので、
       同じ速さだと8秒を超えてしまう。 */
    /* ★2026-09-10 社長「タイピングをもっとゆっくりに」＝55 → 90ミリ秒。
       この見出しは52文字なので、1文字90msで打ち終わりまで約4.9秒。
       ここの数字ひとつで速さが決まる（大きくするほどゆっくり）。 */
    var STEP = 90;
    var START_DELAY = 250;
    var started = false;
